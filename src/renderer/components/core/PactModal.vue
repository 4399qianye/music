...
material-modal(:show="!setting.isAgreePact || isShowPact" @close="handleClose(false)" :bgClose="setting.isAgreePact" :close-btn="setting.isAgreePact")
  main(:class="$style.main")
    ...
    div.select.scroll(:class="$style.content")
      ...
      br
      p 词语约定：本协议中的“本软件”指清韵音乐桌面版项目；“使用者”指签署本协议的使用者；“官方音乐平台”指对本软件内置的包括酷我、酷狗、咪咕等音乐源的官方平台统称；“版权数据”指包括但不限于图像、音频、名字等在内的他人拥有所属版权的数据。
      br
      p
        strong 1、
      ...
      p
        strong 6、
        | 本项目完全免费，且开源发布于&nbsp;
        span.hover.underline(@click="openUrl('/')") 网络
